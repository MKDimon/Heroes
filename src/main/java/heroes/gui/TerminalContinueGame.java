...
public class TerminalContinueGame {
    private static final Logger logger = LoggerFactory.getLogger(TerminalContinueGame.class);
    public static void continueGame(final TerminalWrapper tw, final Data data) {
