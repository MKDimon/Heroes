...
public class MenuTitleDrawers {
    ...
    public static void drawChoose(final TerminalWrapper tw, final TerminalPosition tp) {
        TextGraphics tg = tw.getScreen().newTextGraphics();
        int i = 1;
    ...
    public static void drawTroops(final TerminalWrapper tw, final TerminalPosition tp) {
        TextGraphics tg = tw.getScreen().newTextGraphics();
        int i = 1;
    ...
    public static void drawArmyHereDisclaimer(final TerminalWrapper tw, final TerminalPosition tp) {
        TextGraphics tg = tw.getScreen().newTextGraphics();
        int i = 1;
    ...
    public static void drawArmyNotHereDisclaimer(final TerminalWrapper tw, final TerminalPosition tp) {
        TextGraphics tg = tw.getScreen().newTextGraphics();
        int i = 1;
