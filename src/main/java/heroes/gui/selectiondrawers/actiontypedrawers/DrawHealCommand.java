...
public class DrawHealCommand extends DrawCommand {
    public DrawHealCommand(final TerminalWrapper tw, final Position att, final Position def) {
        super(tw, att, def);
    }
    ...
    public void execute() {
        ...
        TerminalSelectionDrawer.drawSelection(super.getTw(), utg.getPair(super.getDef()), '+', Colors.PINK);
    }
}
